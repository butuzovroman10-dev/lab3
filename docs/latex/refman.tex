...
\renewcommand{\familydefault}{\sfdefault}
  ...
  % Hyperlinks
    ...
    \hypersetup{%
      ...
      citecolor=blue,%
      unicode,%
      pdftitle={Matrix\+Project -\/ Шифровальщик сообщений},%
      pdfsubject={Реализация шифра перестановки методом транспонирования матрицы}%
    }
...
\begin{document}
  ...
  \vspace*{7cm}
  \begin{center}%
  {\Large Matrix\+Project -\/ Шифровальщик сообщений}\\
  [1ex]\large 1.\+0 \\
  \vspace*{1cm}
